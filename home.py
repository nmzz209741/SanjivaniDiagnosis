...
def diabetesClassifier():
    ...
    if output == 0:
        return render_template('diabetesPrediction.html',
                               value="Congratulations!! You are safe from diabetes.Keep visiting nearby hospitals for regular checkups.")
    else:
        return render_template('diabetesPrediction.html',
                               value="There are high chances of having diabetes. Please visit nearby hospital soon.")
...
def heartDiseaseClassifier():
    ...
    if output == 0:
        return render_template('heartDiseasePrediction.html',
                               value="Congratulations!! You are safe from heart disease.Keep visiting nearby hospitals for regular checkups.")
    else:
        return render_template('diabetesPrediction.html',
                               value="There are high chances of having heart disease. Please visit nearby hospital soon.")
...
def cancerClassifier():
    ...
    if output == 0:
        return render_template('cancerPrediction.html',
                               value="Congratulations!! You are safe from cancer.Keep visiting nearby hospitals for regular checkups.  ")
    else:
        return render_template('cancerPrediction.html',
                               value="There are high chances of having cancer. Please visit nearby hospital soon.")
